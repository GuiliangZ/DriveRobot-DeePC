#!/usr/bin/env python3
"""
Additive Enhancement Controller - Preserves Baseline PID Exactly
WITH REAL-TIME IWR AND RMSSE METRICS DISPLAY

Architecture:
- Baseline PID (utils_deepc.py) = COMPLETELY UNCHANGED
...
algorithm_name = "EnhancedPID-Controller-ForPrecision"
latest_speed = None
latest_force = None
        ...
        try:
            ...
            if log_data:
                ...
                excel_filename = "{}_{}_DR_log_{}_{}_{}_Start{}%_{}_Ts{}.xlsx".format(
                    ...
                    veh_modelName, 
                    cycle_key, 
                    "Additive",  # Mark as additive version
                    SOC_CycleStarting,
                    algorithm_name, 
                    Ts)
